...
<div id="wrapper">
    <form action="{{ route('login') }}" method="post">
        <p>Email</p>
        <input type="test"name="email"class="form-control"> <br>
        <p>Password</p>
        <input type="password"name="password"class="form-control"> <br>
        <input type="submit" class="btn btn-default btn_reg" value="Register">
    </form>
    <a href="#" title="Facebook" class="btn btn-facebook btn-lg"><i class="fa fa-facebook fa-fw"></i> SignIn with facebook</a>
</div>
